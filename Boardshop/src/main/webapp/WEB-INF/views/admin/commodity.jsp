...
<div class="row">
  	...
  	<div class="col-md-7 col-xs-12">
		<form:form class="form-horizontal" action="/admin/commodity" method="POST" modelAttribute="commodity" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label for="price" style="color: #A02525; text-align: left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="price" /></label>
			</div> 
			<div class="form-group">
			...
			<div class="form-group">
				<label for="producer" style="color: #A02525; text-align: left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="producer" /></label>
			</div> 
			<div class="form-group">
				<label for="producer" class="col-sm-2 control-label">Producer</label>
				<div class="col-sm-5">
					<form:select class="form-control" path="producer" id="producer" items="${producers}" itemLabel="name" itemValue="id"/>
				</div>
			</div>
			<div class="form-group">
				<label for="producer" class="col-sm-2 control-label">Category</label>
				<div class="col-sm-5">
					<form:select class="form-control" path="category" id="category" items="${categories}" itemLabel="name" itemValue="id"/>
				</div>
			</div> 
			<div class="form-group">
				<label for="description" style="color: #A02525; text-align: left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="description" /></label>
			</div> 
			<div class="form-group">
...
<c:forEach items="${page.content}" var="commodity">
	<div class="row">
		<div class="col-md-1 col-xs-1"><img class="img-rounded" width="100%" src="/images/commodity/${commodity.id}.jpg?version=${commodity.version}"></div> 

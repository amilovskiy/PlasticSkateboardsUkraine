...
<div id="indexContent" class="col-md-12">
	<div class="row">
		...
		<div class="col-md-7 col-xs-12">
			<form:form class="form-horizontal" action="/admin/producer" method="POST" 
				modelAttribute="producer" enctype="multipart/form-data">
				<div class="form-group">
	...
	<c:forEach items="${page.content}" var="producer">
		<div class="row">
			<div class="col-md-1 col-xs-1"><img class="img-rounded" width="100%" src="/images/producer/${producer.id}
				.jpg?version=${producer.version}"></div>
			<div class="col-md-3 col-xs-3">${producer.name}</div>
			<div class="col-md-3 col-xs-3">
				<a class="btn btn-warning" href="/admin/producer/update/${producer.id}">update</a> 
				<a class="btn btn-danger" href="/admin/producer/delete/${producer.id}">delete</a>
			</div>
		</div>
	</c:forEach>

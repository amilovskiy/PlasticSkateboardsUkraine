				...
				<div class="col-md-10">
					<c:forEach items="${commodities}" var="commodity">								
						<div class="row">
							...
							<div class="col-md-4"><div class="row"><h2><b><a href="/user/productPage/${commodity.id}">
								${commodity.name}</a></b></h2></div><div class="row">${commodity.price}<b> $</b></div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-11">
					<c:forEach items="${commodities}" var="commodity">								
						<div class="row">
							<div class="col-md-3 col-xs-3"><a href="/user/productPage/notUser/${commodity.id}">
								<img class="img-rounded" width="100%" src="/images/commodity/${commodity.id}
									.jpg?version=${commodity.version}"></a></div>
							<div class="col-md-4"><div class="row"><h2><b><a href="/user/productPage/notUser/${commodity.id}">
							${commodity.name}</a></b></h2></div><div class="row">${commodity.price}<b> $</b></div>
								${commodity.description}</div>										
						</div>
						<div id="marTop" class="col-md-12"></div>

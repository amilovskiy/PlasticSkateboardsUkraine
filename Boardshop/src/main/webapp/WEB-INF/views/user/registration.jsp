			...
			<div class="col-sm-12 col-xs-12">
				<form:form class="form-horizontal" action="/registration" method="POST" modelAttribute="user">
		  			<div class="form-group">
						<label for="email" style="color: #A02525; text-align: left;" 
							class="col-sm-offset-2 col-sm-5"><form:errors path="email"/></label>
					</div>
					<div class="form-group">
		  			...
		  			<div class="form-group">
						<label for="email" style="color: #A02525; text-align: left;" 
							class="col-sm-offset-2 col-sm-5"><form:errors path="password"/></label>
					</div>
					<div class="form-group">
